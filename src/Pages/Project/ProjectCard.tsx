...
const ProjectCard:FC<Props> = ({title,src}) => {
  return (
    <div className="w-78 h-70 shadow border border-[#FD853A] bg-[#ffffff19] backdrop-blur-md rounded-4xl flex flex-col justify-end items-center gap-6">
